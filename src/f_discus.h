...
coco_problem_t *f_discus_bbob_problem_allocate(const size_t function, const size_t dimension, const size_t instance,
...
void f_discus_evaluate(coco_problem_t *problem, const double *x, double *y);
