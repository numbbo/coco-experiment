 ...
 */
typedef struct logger_bbob_data_s {
 ...
 * x1 | x2...
 */
const char *logger_bbob_data_format = "bbob-new2";
 ...
 */
void logger_bbob_open_data_file(FILE **data_file, const char *path, const char *file_name,
