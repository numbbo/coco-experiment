...
#include "transform_vars_x_hat.cpp"
#include "transform_vars_z_hat.cpp"
...
static coco_problem_t* f_schwefel_allocate(const size_t number_of_variables) {
  ...
  coco_problem_t* problem = coco_problem_allocate_from_scalars("Schwefel function", f_schwefel_evaluate, nullptr,
