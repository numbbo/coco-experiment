/**
 * @file transform_obj_uniform_noise.cpp
 * @brief Implementation of the Uniform noise model
 */
#include "coco.h"
#include "suite_bbob_noisy_utilities.cpp"
...
static coco_problem_t* transform_obj_gaussian_noise(coco_problem_t* inner_problem, const double beta) {
  ...
  data->beta = beta;
  problem = coco_problem_transformed_allocate(inner_problem, data, nullptr, "gaussian_noise_model");
