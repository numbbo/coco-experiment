/**
 * @file transform_vars_blockrotation_helpers.cpp
...
#include "coco_random.cpp" /*tmp*/
#include "coco_utilities.cpp"
#include "suite_bbob_legacy_code.cpp" /*tmp*/
 ...
 */
static size_t* coco_get_block_sizes(size_t* nb_blocks, size_t dimension, char const* suite_name) {
  size_t* block_sizes;
  size_t block_size;
  size_t i;
