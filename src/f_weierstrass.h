...
typedef struct f_weierstrass_data_s f_weierstrass_data_t;
...
coco_problem_t *f_weierstrass_allocate(const size_t number_of_variables);
void f_weierstrass_evaluate(coco_problem_t *problem, const double *x, double *y);
double f_weierstrass_raw(const double *x, const size_t number_of_variables, f_weierstrass_data_t *data);
