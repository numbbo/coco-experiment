 ...
 */
coco_suite_t *suite_bbob_initialize(void) {
 ...
 */
const char *suite_bbob_get_instances_by_year(const int year) {
 ...
 */
coco_problem_t *suite_bbob_get_problem(coco_suite_t *suite, const size_t function_idx,
