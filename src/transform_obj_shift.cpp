...
static coco_problem_t* transform_obj_shift(coco_problem_t* inner_problem, const double offset) {
  ...
  problem = coco_problem_transformed_allocate(inner_problem, data, nullptr, "transform_obj_shift");
  ...
  problem->evaluate_gradient =
      transform_obj_shift_evaluate_gradient; /* TODO (NH): why do we need a new function pointer here? */
