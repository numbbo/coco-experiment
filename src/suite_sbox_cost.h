...
#include "coco.h"
#undef INTERFACE
coco_problem_t *suite_sbox_cost_get_problem(coco_suite_t *suite, const size_t function_idx, const size_t dimension_idx,
                                            const size_t instance_idx);
coco_problem_t *coco_get_bbob_boxed_problem(const size_t function, const size_t dimension, const size_t instance);
