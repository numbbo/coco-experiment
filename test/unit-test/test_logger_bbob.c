...
MU_TEST(test_logger_bbob_triggers) {
  ...
  observer = coco_observer("bbob", "number_target_triggers: 1 number_evaluation_triggers: 20 lin_target_precision: 100");
  ...
  observer = coco_observer("bbob", "number_target_triggers: 1 number_evaluation_triggers: 20 lin_target_precision: 1e-3 log_target_precision: 1e-5");
  /* Use the 2-D sphere function */
  problem = coco_suite_get_next_problem(suite, observer);
  logger = (logger_bbob_data_t *) coco_problem_transformed_get_data(problem);
  ...
  observer = coco_observer("bbob", "number_target_triggers: 1 number_evaluation_triggers: 20 lin_target_precision: 10 log_target_precision: 1e-5");
  /* Use the 2-D sphere function */
  problem = coco_suite_get_next_problem(suite, observer);
  logger = (logger_bbob_data_t *) coco_problem_transformed_get_data(problem);
